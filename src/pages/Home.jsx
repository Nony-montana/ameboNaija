...
import { setAllPosts, setTrendingPosts, setLoading, setError } from "../store/slices/postSlice";
...
const Home = () => {
    ...
    const { posts, trendingPosts, loading, error, totalPages, currentPage } = useSelector(
        (state) => state.posts
    );
                                        ...
                                        >
                                            ...
                                            <Link to={`/post/${featuredPost.slug}`}>
                                                <h3
                                                    ...
                                                    style={{ color: "white", fontSize: "22px", lineHeight: "1.4" }}
                                                >
                                                    {featuredPost.title}
                                                </h3>
                                            </Link>
