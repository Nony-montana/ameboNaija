...
const SinglePost = () => {
  ...
  const handleLike = async () => {
    if (!isLoggedIn) {
      showMessage("Please login to like this post", "error");
      return;
    }
    try {
                    ...
                    <div className="w-100">
                      ...
                      <div className="d-flex justify-content-between align-items-center">
                        ...
                        <div className="d-flex align-items-center gap-2">
                          ...
                          {/* ELLIPSIS MENU — only visible to comment owner or admin */}
                          {(user?._id === c.user?._id ||
                            user?.roles === "admin") &&
                            editingCommentId !== c._id && (
                              <div className="position-relative">
                                ...
                                {/* DROPDOWN — only renders for the specific comment whose ID matches */}
                                {openMenuId === c._id && (
                                  <div
                                  ...
                                  >
                                    {/* EDIT — owner only, within 10 mins */}
                                    {user?._id === c.user?._id &&
                                      Date.now() -
                                        ...
                                        <button
                                          onClick={() => {
                                            ...
                                            setOpenMenuId(null); // close menu when edit opens
                                          }}
                    ...
                    style={{
                      backgroundColor:
                        singlePost.category === cat
                          ...
                          : "var(--light-green)",
                      color:
                        singlePost.category === cat ? "white" : "var(--green)",
                      padding: "5px 12px",
                      borderRadius: "20px",
                      fontSize: "13px",
                      fontWeight: "600",
