...
const AdminUsers = () => {
  ...
  const handleRoleChange = async (userId, currentRole) => {
    ...
    try {
      ...
      setUsers(
        users.map((u) => (u._id === userId ? { ...u, roles: newRole } : u)),
      );
                ...
                >
                  <td style={{ padding: "14px", fontSize: "13px" }}>
                    <div className="d-flex align-items-center gap-2">
                      {u.roles === "admin" && (
                        <FaUserShield size={13} color="var(--green)" />
                      )}
                  ...
                  <td style={{ verticalAlign: "middle" }}>
                    <span
                      ...
                      style={{
                        ...
                        borderRadius: "20px",
                        backgroundColor:
                          u.roles === "admin" ? "#f0fdf4" : "#f3f4f6",
                        color:
                          u.roles === "admin" ? "var(--green)" : "var(--gray)",
                      }}
                    >
                      {u.roles}
                    </span>
                  ...
                  <td style={{ verticalAlign: "middle" }}>
                    <span
                      ...
                      style={{
                        ...
                        borderRadius: "20px",
                        backgroundColor:
                          u.isActive === false ? "#fff5f5" : "#f0fdf4",
                        color:
                          u.isActive === false ? "#dc2626" : "var(--green)",
                      }}
                    >
                  ...
                  <td style={{ verticalAlign: "middle" }}>
                    ...
                    {u._id !== user.id && (
                      <div className="d-flex gap-2 flex-wrap">
                        ...
                        <button
                          onClick={() =>
                            handleStatusChange(u._id, u.isActive !== false)
                          }
                          className="btn btn-sm fw-semibold d-flex align-items-center gap-1"
                          style={{
                            fontSize: "11px",
                            backgroundColor:
                              u.isActive === false ? "#f0fdf4" : "#fff5f5",
                            color:
                              u.isActive === false ? "var(--green)" : "#dc2626",
                            border: "1px solid var(--border)",
                          }}
                        >
                          {u.isActive === false ? (
        ...
        <div className="d-md-none d-flex flex-column gap-3">
          {users.map((u) => (
            <div
              ...
              style={{ opacity: u.isActive === false ? 0.6 : 1 }}
            >
              ...
              {u._id !== user.id && (
                <div className="d-flex gap-2 flex-wrap">
                  <button
                    ...
                    style={{
                      ...
                      backgroundColor:
                        u.roles === "admin" ? "#f3f4f6" : "#f0fdf4",
                      color:
                        u.roles === "admin" ? "var(--gray)" : "var(--green)",
                      border: "1px solid var(--border)",
                    }}
                  >
                  ...
                  >
                    {u.isActive === false ? (
                      <>
                        <FaCheckCircle size={11} className="me-1" />
                        Reactivate
                      </>
                    ) : (
                      <>
                  ...
                  <button
                    onClick={() =>
                      openDeleteModal(u._id, `${u.firstName} ${u.lastName}`)
                    }
                    className="btn btn-sm"
                    data-bs-toggle="modal"
                    data-bs-target="#userDeleteModal"
        ...
        <div className="modal-dialog modal-dialog-centered">
          ...
          >
            ...
            <div className="modal-body pt-2">
              ...
              >
                <BiInfoCircle /> This will also delete all their posts. This
                cannot be undone!
              </p>
            </div>
