...
const Notifications = () => {
  ...
  const handleMarkAsUnread = async (id) => {
    try {
      ...
      setNotifications(
        notifications.map((n) => (n._id === id ? { ...n, isRead: false } : n)),
      );
      setOpenMenu(null);
    } catch (err) {
  ...
  const getTypeStyle = (type) => {
    switch (type) {
      ...
      case "comment":
        return { bg: "#e8f4fd", color: "#1d4ed8" };
      default:
        return { bg: "#f3f4f6", color: "var(--gray)" };
    }
  };
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  ref={openMenu === n._id ? menuRef : null}
                >
                  <button
                    onClick={() =>
                      setOpenMenu(openMenu === n._id ? null : n._id)
                    }
