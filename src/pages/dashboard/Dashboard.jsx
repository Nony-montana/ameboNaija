                    ...
                    <div className="col-md-4">
                        <Link to="/dashboard/create" style={{ textDecoration: "none" }}>
                            <div
                                ...
                                style={{ border: "2px solid var(--light-green)", transition: "all 0.2s ease", cursor: "pointer" }}
                                onMouseEnter={(e) => e.currentTarget.style.borderColor = "var(--green)"}
                                onMouseLeave={(e) => e.currentTarget.style.borderColor = "var(--light-green)"}
                            >
                                <div
                                    className="mb-3 d-flex align-items-center justify-content-center rounded-circle"
                                    style={{ width: "60px", height: "60px", backgroundColor: "var(--light-green)" }}
                                >
                                    <FaPen size={24} color="var(--green)" />
                                </div>
                                <h6 className="fw-bold" style={{ color: "var(--text)" }}>Write a Post</h6>
                    ...
                    <div className="col-md-4">
                        <Link to="/dashboard/my-posts" style={{ textDecoration: "none" }}>
                            ...
                            >
                                ...
                                <h6 className="fw-bold" style={{ color: "var(--text)" }}>My Posts</h6>
                                <p style={{ fontSize: "13px", color: "var(--gray)" }}>
                    ...
                    {user?.roles === "admin" && (
                        <div className="col-md-4">
                            <Link to="/dashboard/pending" style={{ textDecoration: "none" }}>
                                <div
                                    className="p-4 rounded shadow-sm h-100 bg-white d-flex flex-column align-items-center text-center"
                                    style={{ border: "2px solid #fff3cd", transition: "all 0.2s ease", cursor: "pointer" }}
                                    onMouseEnter={(e) => e.currentTarget.style.borderColor = "var(--gold)"}
                                    onMouseLeave={(e) => e.currentTarget.style.borderColor = "#fff3cd"}
                                >
                                    <div
                                        className="mb-3 d-flex align-items-center justify-content-center rounded-circle"
                                    ...
                                    <h6 className="fw-bold" style={{ color: "var(--text)" }}>Admin Panel</h6>
                                    <p style={{ fontSize: "13px", color: "var(--gray)" }}>
