...
import { FaCheck, FaTimes, FaEye, FaUserLock } from "react-icons/fa";
        ...
        <div style={{ backgroundColor: "var(--bg)", minHeight: "100vh" }}>
            <div className="container py-5">
                ...
                {pendingPosts.length === 0 && !loading && (
                    ...
                    >
                        <p style={{ fontSize: "40px" }}><GiPartyPopper color="green"/></p>
                        ...
                        >
                            <div className="row align-items-center g-3">
                                ...
                                <div className="col-md-2">
                                    <img
                                        src={post.image || "https://placehold.co/150x100?text=No+Image"}
                                        alt={post.title}
                                        style={{
                                            width: "100%",
                                            height: "80px",
                                ...
                                <div className="col-md-7">
                                    ...
                                    <h6 className="fw-bold mt-1 mb-1" style={{ fontSize: "15px" }}>
                                        {post.title}
                                    </h6>
