...
import { FaEye, FaClock, FaUserCircle, FaArrowLeft, FaCheck, FaTimes } from "react-icons/fa";
...
const PreviewPost = () => {
    ...
    useEffect(() => {
        ...
        const fetchPost = async () => {
            try {
                const res = await API.get(`/posts/admin/preview/${slug}`);
                    ...
                    <div className="col-lg-4">
                        ...
                        >
                            <h6
                                ...
                                style={{ borderBottom: "2px solid var(--gold)", color: "var(--text)" }}
                            >
                                <FcNews/> Post Details
                            </h6>
